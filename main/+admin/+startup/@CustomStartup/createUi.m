...
% setup menus
editMenu = uimenu(view, ...
  'Text','Edit' ...
  );
uimenu(editMenu, ...
  'Text', 'Add &User...', ...
  'MenuSelectedFcn', @(s,e)obj.createNewUsers() ...
  );
uimenu(editMenu, ...
  'Text', 'Re&fresh Users', ...
  'MenuSelectedFcn', @(s,e)obj.populateUserSetups() ...
  );
uimenu(editMenu, ...
  'Text', 'Change &Lab Name', ...
  'MenuSelectedFcn', @(s,e)obj.changeLabName() ...
  );
uimenu(editMenu, ...
  'Text', '&Import Colony List', ...
  'Separator', 'on', ...
  'MenuSelectedFcn', @obj.importColonyList ...
  );
uimenu(editMenu, ...
  'Text', 'Edit Colony &List', ...
  'MenuSelectedFcn', @obj.updateColonyList ...
  );
uimenu(editMenu, ...
  'Text', '&Reset', ...
  'Separator', 'on', ...
  'MenuSelectedFcn', @(s,e)obj.reset() ...
  );
